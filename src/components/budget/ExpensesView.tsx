...
import { DollarSign, Plus, Search, AlertTriangle, ShieldAlert, Download } from 'lucide-react';
...
export const ExpensesView: React.FC = () => {
  ...
  const canAdd = store.hasPermission('budget', 'add');
  const canExport = store.hasPermission('budget', 'export');
